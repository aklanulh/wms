...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('customers.update', $customer) }}" method="POST">
            ...
            <div class="mb-6">
                <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Nama Customer</label>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_person_2" id="contact_person_2" value="{{ old('contact_person_2', $customer->contact_person_2) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    
                    <div>
                        <label for="contact_person_3" class="block text-xs text-gray-600 mb-1">Kontak 3 (Opsional)</label>
                        <input type="text" name="contact_person_3" id="contact_person_3" value="{{ old('contact_person_3', $customer->contact_person_3) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_3" id="phone_3" value="{{ old('phone_3', $customer->phone_3) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
