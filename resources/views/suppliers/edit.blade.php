...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit Distributor</h1>
    </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_person_2" id="contact_person_2" value="{{ old('contact_person_2', $supplier->contact_person_2) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    
                    <div>
                        <label for="contact_person_3" class="block text-xs text-gray-600 mb-1">Kontak 3 (Opsional)</label>
                        <input type="text" name="contact_person_3" id="contact_person_3" value="{{ old('contact_person_3', $supplier->contact_person_3) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_3" id="phone_3" value="{{ old('phone_3', $supplier->phone_3) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
