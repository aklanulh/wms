...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center mb-6">
        <a href="{{ route('products.show', $product) }}" class="text-gray-600 hover:text-gray-900 mr-4">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST">
            ...
            <div class="mt-6 space-y-1">
                ...
                <textarea name="description" id="description" rows="3" 
                          ...
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">{{ old('description', $product->description) }}</textarea>
            </div>
            ...
            <div class="mt-8 border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="date" name="expired_date" id="expired_date" value="{{ old('expired_date', $product->expired_date ? $product->expired_date->format('Y-m-d') : '') }}"
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="distribution_permit" id="distribution_permit" value="{{ old('distribution_permit', $product->distribution_permit) }}"
